...
Currently I work at [D2iQ](https://d2iq.com)(previously, Mesosphere) as a Software Engineer(Contractor) from TCS. I work with Python, Go, Docker, Kubernetes, DC/OS, Confluent, Apache Kafka and Zookeeper, Elasticsearch etc. and responsible to add features and release the latest versions and make them avaibale on our platforms. I am also a voting member at [Python Software Foundation](https://www.python.org/psf/).
